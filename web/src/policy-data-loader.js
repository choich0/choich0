...
async function getPolicy() {
  ...
  const response = await apiClient.get("policyDh");
  ...
  const response2 = await apiClient2.get("policyLe");
  ...
  const response3 = await apiClient3.get("policyCon");
  ...
  const response4 = await apiClient4.get("policyMc");

...
async function getAnc() {
  ...
  const response = await apiClient.get("ancCm");
  ...
  const response2 = await apiClient2.get("ancSafety");
  ...
  const response3 = await apiClient3.get("ancPol");
  ...
  const response4 = await apiClient4.get("ancGre");

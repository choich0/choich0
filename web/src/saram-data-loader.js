...
async function getSaram() {
  const apiClient = axios.create({
    baseURL: process.env.CB_API_BASE_URL || "http://localhost:8080",
  });

  const response = await apiClient.get("saramPlan");
  ...
  const response2 = await apiClient2.get("saramEval");
  ...
  const response3 = await apiClient3.get("saramGroup");
  ...
  const response4 = await apiClient4.get("saramPol");
  ...
  const response5 = await apiClient5.get("saramTrend");
  const result5 = response5.data.result;

  const nTitle5_1 = result5[result5.length -1].nTitle;
  const nDate5_1 = result5[result5.length -1].nDate;
  const nLink5_1 = result5[result5.length -1].nLink;

  const nTitle5_2 = result5[result5.length -2].nTitle;
  const nDate5_2 = result5[result5.length -2].nDate;
  const nLink5_2 = result5[result5.length -2].nLink;

  const nTitle5_3 = result5[result5.length -3].nTitle;
  const nDate5_3 = result5[result5.length -3].nDate;
  const nLink5_3 = result5[result5.length -3].nLink;

  const nTitle5_4 = result5[result5.length -4].nTitle;
  const nDate5_4 = result5[result5.length -4].nDate;
  const nLink5_4 = result5[result5.length -4].nLink;

  const nTitle5_5 = result5[result5.length -5].nTitle;
  const nDate5_5 = result5[result5.length -5].nDate;
  const nLink5_5 = result5[result5.length -5].nLink;

  const nTitle5_6 = result5[result5.length -6].nTitle;
  const nDate5_6 = result5[result5.length -6].nDate;
  const nLink5_6 = result5[result5.length -6].nLink;

  const nTitle5_7 = result5[result5.length -7].nTitle;
  const nDate5_7 = result5[result5.length -7].nDate;
  const nLink5_7 = result5[result5.length -7].nLink;

  const nTitle5_8 = result5[result5.length -8].nTitle;
  const nDate5_8 = result5[result5.length -8].nDate;
  const nLink5_8 = result5[result5.length -8].nLink;

  const nTitle5_9 = result5[result5.length -9].nTitle;
  const nDate5_9 = result5[result5.length -9].nDate;
  const nLink5_9 = result5[result5.length -9].nLink;

  const nTitle5_10 = result5[result5.length -10].nTitle;
  const nDate5_10 = result5[result5.length -10].nDate;
  const nLink5_10 = result5[result5.length -10].nLink;
  ...
  return {
    ...
    nTitle5_1, nDate5_1, nLink5_1,
    nTitle5_2, nDate5_2, nLink5_2,
    nTitle5_3, nDate5_3, nLink5_3,
    nTitle5_4, nDate5_4, nLink5_4,
    nTitle5_5, nDate5_5, nLink5_5,
    nTitle5_6, nDate5_6, nLink5_6,
    nTitle5_7, nDate5_7, nLink5_7,
    nTitle5_8, nDate5_8, nLink5_8,
    nTitle5_9, nDate5_9, nLink5_9,
    nTitle5_10, nDate5_10, nLink5_10,
  };
}

module.exports = { getSaram };

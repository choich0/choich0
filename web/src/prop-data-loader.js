...
async function getProp() {
  ...
  const response = await apiClient.get("propMk");
  ...
  const response2 = await apiClient2.get("propFn");
  ...
  const response3 = await apiClient3.get("propKld");
  ...
  const response4 = await apiClient4.get("propDnews");

...
async function getCad() {
  ...
  const response = await apiClient.get("cadTv");
  ...
  const response2 = await apiClient2.get("cadSpe");
  ...
  const response3 = await apiClient3.get("cadLec");
  ...
  const response4 = await apiClient4.get("cadNews");
